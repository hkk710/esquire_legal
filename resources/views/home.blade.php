...
@include('partials.navbar')
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/bg_1.png'); height: 840px; background-position: 50% -3.8px;" data-stellar-background-ratio="0.9">
